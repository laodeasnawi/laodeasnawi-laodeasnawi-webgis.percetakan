      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-md-offset-4">
            ...
            <h4 class="white">Sistem Informasi Geografis Jasa Percetakan</h4>
          <h3 class="white">Kota Ambon</h3>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4>SISTEM INFORMASI GEOGRAFIS PENYEDIA JASA PERCETAKAN DI KOTA AMBON BERBASIS WEBGIS</h4>
        <p>Program ini dibuat oleh Kelompok 4 untuk Tugas Praktikum GIS 2024.</p>
